package io.afridata.notification.kafka;

import com.fasterxml.jackson.databind.ObjectMapper;
import io.afridata.notification.entity.Project;
import io.afridata.notification.entity.User;
import io.afridata.notification.repository.ProjectRepository;
import io.afridata.notification.repository.UserRepository;
import io.afridata.notification.service.EmailService;
    ...
    public void consume(ConsumerRecord<String, String> record, Acknowledgment ack) {
        try {
            ...
            if ("WARNING_80".equals(status) && !emailService.wasSentRecently(projectId, "QUOTA_WARNING", 60)) {
                String subject = "Afridata: You've used 80% of your daily quota";
            ...
            if ("EXCEEDED".equals(status) && !emailService.wasSentRecently(projectId, "QUOTA_EXCEEDED", 60)) {
                String subject = "Afridata: Daily quota exceeded — messages are being rejected";
                String body = String.format(
