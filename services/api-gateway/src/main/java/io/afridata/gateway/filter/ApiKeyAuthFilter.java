package io.afridata.gateway.filter;

import io.afridata.gateway.repository.ApiKeyRepository;
 ...
 * Detects API keys (Bearer tokens starting with "afridata_"), validates them
...
public class ApiKeyAuthFilter extends OncePerRequestFilter {
    ...
    static final String PROJECT_ID_ATTR = "apiKeyProjectId";
    private static final String API_KEY_PREFIX = "afridata_";
